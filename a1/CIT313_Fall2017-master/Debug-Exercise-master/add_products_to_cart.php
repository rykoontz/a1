...
<?php
  ...
  include_once(ABSOLUTE_PATH . '/classes/fruit_product.class.php'); // forgot to include the frut product class
	...
	$aryProductArray = unserialize($_SESSION['aryProductArray']); //Misspelled aryProductArray
