...
<?php
	...
	$aryProductArray = unserialize($_SESSION['aryProductArray']); //Named it products instead of product
	...
	for ($x=0; $x < count($aryCartArray); $x++) {
		...
		$thisProduct = $aryProductArray[$aryCartItemArray[0]]; //Forgot to add a semicolon
