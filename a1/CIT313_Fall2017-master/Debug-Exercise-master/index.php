...
<div id="wrapper">
	...
	<form action="<?php echo URL_ROOT . '/add_products_to_inventory.php' ?>" method="post"> <?php //Do not include quotes around URL_ROOT ?>
	...
	} // There was a regular closing brace here instead of a curly brace to close the for loop
	?>
